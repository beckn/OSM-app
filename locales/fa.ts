const fa: { [key: string]: string } = {
    ...
    toyCategoryDescription:
        'Une combinaison de divertissement et de créativité',
    ...
    agentAssignedMssg:
        'Steve notre transporteur est au magasin pour récupérer votre commande.',
    ...
    accessToProvideLocation:
        "Veuillez fournir l'autorisation d'accéder à une livraison meilleure et sans tracas",
    ...
    homePara:
        ' Un marché mondial pour découvrir et acheter tout ce dont vous avez besoin. Tapez simplement ce que vous souhaitez acheter et nous nous occuperons du reste. ',
