...
const DetailsSection: React.FC<Props> = ({ product }) => {
  ...
  return (
    <Box
      padding={"15px 20px"}
      className="bg-palette-card md:bg-transparent  md:w-auto  flex-grow self-center lg:self-start md:mt-0 !-mx-[1rem] lg:ltr:ml-4 lg:rtl:mr-4 md:py-0 rounded-tl-xl rounded-tr-xl flex flex-col z-10"
    >
      <h2
