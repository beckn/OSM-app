...
const OrderSummaryBox: React.FC<OrderSummaryBoxPropsModel> = (props) => {
  ...
  return (
    <>
      {totalQuantity > 0 ? (
        <div
          className="flex-grow sticky bottom-0 left-0 right-0 md:top-36 shadow-lg bg-palette-card border-2 rounded-lg py-4 xl:py-12 px-4 xl:px-8 -mx-[1rem] md:mx-4 xl:mx-8  w-[98vw] md:w-auto  md:min-w-[300px] md:max-w-[400px]"
